...
export const INITIAL_PROGRESS: Record<number, ArticleProgress> = {
  332861: {
    ...
    seoScoreAfter: 100,
    doneAt: '2026-03-01',
    notes: 'Эталонная статья — G#10 (28-03-2026). Метадеск исправлен 2026-03-25',
    googlePos: 10, yandexPos: null, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: POS_SNAPSHOT_DATE, googlePos: null, yandexPos: null },
      { date: '2026-03-28', googlePos: 10, yandexPos: null },
    ],
  },
  5535: {
    status: 'done',
    wordsAfter: 2877,
    doneAt: '2026-03-25',
    notes: '17 H2, 10 FAQ, 9 картинок. Я#38→#13→#30. G#39 (28-03-2026)',
    googlePos: 39, yandexPos: 30, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 39, yandexPos: null },
    ],
  },
  4299: {
    status: 'done',
    wordsAfter: 3200,
    doneAt: '2026-03-25',
    notes: '15 H2, 11 FAQ, 9 картинок. Я#24→#26→#21. G#30 (28-03-2026)',
    googlePos: 30, yandexPos: 21, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 30, yandexPos: null },
    ],
  },
  4305: {
    status: 'done',
    wordsAfter: 3100,
    doneAt: '2026-03-25',
    notes: '15 H2, 3 H3, 11 FAQ, 9 картинок. Я#47→#29→#46. G#60 (28-03-2026)',
    googlePos: 60, yandexPos: 46, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 60, yandexPos: null },
    ],
  },
  5607: {
    status: 'done',
    wordsAfter: 3300,
    doneAt: '2026-03-25',
    notes: '15 H2, 11 FAQ, 9 картинок. Я#19→#14→#29. G#39 (28-03-2026)',
    googlePos: 39, yandexPos: 29, posCheckedAt: '2026-03-28',
    posHistory: [
  ...
  7129: {
    ...
    wordsAfter: 3000,
    doneAt: '2026-03-25',
    notes: '15 H2, 11 FAQ, 9 картинок. Я#39→#39→#32. G#47 (28-03-2026)',
    googlePos: 47, yandexPos: 32, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 47, yandexPos: null },
    ],
  },
  4302: {
    status: 'done',
    wordsAfter: 3100,
    doneAt: '2026-03-25',
    notes: '15 H2, 11 FAQ, 9 картинок. Я#36→—→#50. G#46 (28-03-2026)',
    googlePos: 46, yandexPos: 50, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 46, yandexPos: null },
    ],
  },
  4308: {
    status: 'done',
    wordsAfter: 3200,
    doneAt: '2026-03-25',
    notes: '15 H2, 3 H3, 10 FAQ, 9 картинок. Я#66→—→#47. G#71 (28-03-2026)',
    googlePos: 71, yandexPos: 47, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: '2026-03-25', googlePos: null, yandexPos: 66 },
      { date: '2026-03-26', googlePos: null, yandexPos: null },
      { date: '2026-03-27', googlePos: null, yandexPos: 47 },
      { date: '2026-03-28', googlePos: 71, yandexPos: null },
    ],
  },
  5522: {
    status: 'done',
    wordsAfter: 3000,
    doneAt: '2026-03-25',
    notes: '15 H2, 10 FAQ, 9 картинок. Я#22→#77→— ⚠️. G#31 (28-03-2026)',
    googlePos: 31, yandexPos: null, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 31, yandexPos: null },
    ],
  },
  5558: {
    status: 'done',
    wordsAfter: 3100,
    doneAt: '2026-03-25',
    notes: '15 H2, 10 FAQ, 9 картинок. Я#50→—→#30. G#25 (28-03-2026)',
    googlePos: 25, yandexPos: 30, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: '2026-03-25', googlePos: null, yandexPos: 50 },
      { date: '2026-03-26', googlePos: null, yandexPos: null },
      { date: '2026-03-27', googlePos: null, yandexPos: 30 },
      { date: '2026-03-28', googlePos: 25, yandexPos: null },
    ],
  },
  331661: {
  ...
  333052: {
    ...
    notes: 'Я#19→#34→#35. G#35 (28-03-2026)',
    googlePos: 35, yandexPos: 35, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: '2026-03-25', googlePos: null, yandexPos: 19 },
      { date: '2026-03-26', googlePos: null, yandexPos: 34 },
      { date: '2026-03-27', googlePos: null, yandexPos: 35 },
      { date: '2026-03-28', googlePos: 35, yandexPos: null },
    ],
  },
  332955: {
    status: 'done', wordsAfter: 2256, doneAt: '2026-03-25',
    notes: 'G#2→#25 ⚠️ ПАДЕНИЕ. Я#16→#23→#24',
    googlePos: 25, prevGooglePos: 2, yandexPos: 24, posCheckedAt: '2026-03-28',
    posHistory: [
  ...
  333008: {
    ...
    notes: 'Я#37→—→#37. G#91 (28-03-2026) — страница 10+',
    googlePos: 91, yandexPos: 37, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: '2026-03-25', googlePos: null, yandexPos: 37 },
      { date: '2026-03-26', googlePos: null, yandexPos: null },
      { date: '2026-03-27', googlePos: null, yandexPos: 37 },
      { date: '2026-03-28', googlePos: 91, yandexPos: null },
    ],
  },
  332921: {
  ...
  332874: {
    ...
    notes: 'G#9 (28-03-2026) — уже ТОП-10!',
    googlePos: 9, yandexPos: null, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: '2026-03-27', googlePos: null, yandexPos: null },
      { date: '2026-03-28', googlePos: 9, yandexPos: null },
    ],
  },
  333098: {
    status: 'done', wordsAfter: 2464, doneAt: '2026-03-27',
    notes: 'G#2→#56 ⚠️ КРИТИЧЕСКОЕ ПАДЕНИЕ. Я#56→#2→#51 волатильность',
    googlePos: 56, prevGooglePos: 2, yandexPos: 51, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 56, yandexPos: null },
    ],
  },
  333070: {
    status: 'done', wordsAfter: 2735, doneAt: '2026-03-27',
    notes: 'Я—→—→#34. G#33 (28-03-2026)',
    googlePos: 33, yandexPos: 34, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: '2026-03-25', googlePos: null, yandexPos: null },
      { date: '2026-03-26', googlePos: null, yandexPos: null },
      { date: '2026-03-27', googlePos: null, yandexPos: 34 },
      { date: '2026-03-28', googlePos: 33, yandexPos: null },
    ],
  },
  2162: {
    status: 'done', wordsAfter: 611, doneAt: '2026-03-11',
    notes: 'Я—→—→#47. G#48 (28-03-2026)',
    googlePos: 48, yandexPos: 47, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: '2026-03-25', googlePos: null, yandexPos: null },
      { date: '2026-03-26', googlePos: null, yandexPos: null },
      { date: '2026-03-27', googlePos: null, yandexPos: 47 },
      { date: '2026-03-28', googlePos: 48, yandexPos: null },
    ],
  },
  4312: {
    status: 'todo',
  ...
  5707: {
    ...
    wordsAfter: 3100,
    doneAt: '2026-03-25',
    notes: 'G#1→#28 ⚠️ КРИТИЧЕСКОЕ ПАДЕНИЕ. Я#7→#10→#42. Нужен повторный реврайт',
    googlePos: 28, prevGooglePos: 1, yandexPos: 42, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 28, yandexPos: null },
    ],
  },
  732: {
    status: 'done',
    wordsAfter: 2450,
    doneAt: '2026-03-25',
    notes: 'G#3→#8 ⚠️ откат. Я#5→#19→#6',
    googlePos: 8, prevGooglePos: 3, yandexPos: 6, posCheckedAt: '2026-03-28',
    posHistory: [
      ...
      { date: '2026-03-28', googlePos: 8, yandexPos: null },
    ],
  },
  1111: {
    status: 'done',
    wordsAfter: 1800,
    doneAt: '2026-03-25',
    notes: 'G#4 (стабильно). Я#4',
    googlePos: 4, yandexPos: 4, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: POS_SNAPSHOT_DATE, googlePos: 4, yandexPos: 4 },
      { date: '2026-03-28', googlePos: 4, yandexPos: null },
    ],
  },
  8751: {
    status: 'done',
    wordsAfter: 3500,
    doneAt: '2026-03-25',
    notes: 'G#4→#3→#9 ⚠️ волатильность. Я#4',
    googlePos: 9, prevGooglePos: 3, yandexPos: 4, posCheckedAt: '2026-03-28',
    posHistory: [
      { date: POS_SNAPSHOT_DATE, googlePos: 4, yandexPos: 4 },
